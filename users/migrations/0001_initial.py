<<<<<<< HEAD
# Generated by Django 3.2 on 2021-04-09 19:58
=======
# Generated by Django 3.2 on 2021-04-10 01:21
>>>>>>> 86c55a60f7a8a4a07389e98d1f0f424a26df9796
...
<<<<<<< HEAD
                ('end_time', models.DateTimeField(default=datetime.datetime(2021, 4, 9, 14, 3, 30, 103533))),
=======
                ('end_time', models.DateTimeField(default=datetime.datetime(2021, 4, 10, 1, 26, 55, 984221))),
>>>>>>> 86c55a60f7a8a4a07389e98d1f0f424a26df9796
                ('vehicle_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.vehicle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
<<<<<<< HEAD
                ('start_time', models.DateTimeField(default=datetime.datetime(2021, 4, 10, 13, 58, 30, 102535))),
                ('end_time', models.DateTimeField(default=datetime.datetime(2021, 4, 11, 13, 58, 30, 102535))),
                ('vehicle', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.vehicle')),
                ('customer_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.customer')),
                ('sales_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.sales_associate')),
=======
                ('start_time', models.DateTimeField(default=datetime.datetime(2021, 4, 11, 1, 21, 55, 983096))),
                ('end_time', models.DateTimeField(default=datetime.datetime(2021, 4, 12, 1, 21, 55, 983119))),
