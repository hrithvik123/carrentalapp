# Generated by Django 3.2 on 2021-04-12 19:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_time', models.DateTimeField(default=datetime.datetime(2021, 4, 12, 19, 24, 29, 601892))),
                ('vehicle_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.vehicle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_time', models.DateTimeField(default=datetime.datetime(2021, 4, 13, 19, 19, 29, 600812))),
                ('end_time', models.DateTimeField(default=datetime.datetime(2021, 4, 14, 19, 19, 29, 600835))),
