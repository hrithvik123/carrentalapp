    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_time', models.DateTimeField(default=datetime.datetime(2021, 4, 12, 20, 37, 46, 136802))),
                ('vehicle_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.vehicle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_time', models.DateTimeField(default=datetime.datetime(2021, 4, 13, 20, 32, 46, 135411))),
                ('end_time', models.DateTimeField(default=datetime.datetime(2021, 4, 14, 20, 32, 46, 135437))),
